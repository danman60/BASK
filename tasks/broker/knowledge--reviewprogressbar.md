# knowledge: ReviewProgressBar

## What to build

A slim horizontal progress bar showing how much of the corpus a human has decided on. Props: decided and total counts. Show the bar, then a plain sentence beneath giving both absolute numbers and the percentage - never a bare percentage, because a percentage without its denominator misleads. When total is zero, show an empty state sentence instead of a zero-width bar and do not divide.

## Target file — write EXACTLY this path, and nothing else

`/home/danman60/projects/uvalux-platform/apps/web/src/components/compass/knowledge/ReviewProgressBar.tsx`
...
1. `/home/danman60/projects/uvalux-platform/apps/web/src/components/compass/knowledge/ReviewProgressBar.tsx` exists and exports the component/function described above.
2. It imports what it uses from `@/lib/contract`.
3. `npx tsc --noEmit && python3 -m broker.vocab /home/danman60/projects/uvalux-platform/apps/web/src/components/compass/primitives.tsx /home/danman60/projects/uvalux-platform/apps/web/src/components/compass/knowledge/ReviewProgressBar.tsx --contract /home/danman60/projects/uvalux-platform/packages/core/src/knowledge/curation/types.ts` passes with exit code 0.
