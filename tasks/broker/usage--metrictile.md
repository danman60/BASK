...
A tile for one product-usage metric. Props: a label, a value, a denominator, an optional trend direction, and a contributor count. Always show the value together with its denominator - a percentage alone is forbidden here. Always show how many salons contributed. Accept an optional suppressed boolean; when true, replace the value entirely with a sentence saying there are not enough salons to show this, and show no numbers at all. Reuse TrendArrow and StatRow from the exemplar.
...
1. `/home/danman60/projects/uvalux-platform/apps/web/src/components/compass/usage/MetricTile.tsx` exists and exports the component/function described above.
