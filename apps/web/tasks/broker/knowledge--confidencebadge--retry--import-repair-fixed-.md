# knowledge: ConfidenceBadge (retry, import repair fixed)

## What to build

A small badge showing how confident we are that a Claim was matched to its transcript. When confidence is 0, say it could not be matched to the transcript. When the title confidence is interpolated, say the speaker was inferred from the agenda. Otherwise show the confidence as a percentage. Match the exemplar's badge styling and severity classes.
