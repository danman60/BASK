# knowledge: ProvenanceCard (retry, import repair fixed)

## What to build

A card showing where a Claim came from: the source transcript and the timecode it was said at, formatted for reading. Match the exemplar's card styling and its class vocabulary.
